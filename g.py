...
TOKEN = '7564353736:AAEirTyxwvFDfTZYwuYkz6ey08g1BD4X6b4' #Enter_Bot_Token_within_the_colons'
MONGO_URI = 'mongodb+srv://deepaidb:51354579914@deepaidb.imzonfj.mongodb.net/?retryWrites=true&w=majority&appName=deepaidb'
FORWARD_CHANNEL_ID = -   7360174117    # enter the log channel id
CHANNEL_ID = -7360174117 # enter the log channel id
error_channel_id = -7360174117        # enter the log channel id
